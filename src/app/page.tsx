...
export default function LoginPage() {
  const { login, loginWithGoogle, loginWithFacebook, loginWithApple, loginWithMicrosoft, loginWithTwitter } = useAuth();
  ...
  const handleSocialLogin = async (provider: SocialProvider) => {
    ...
    try {
        ...
        toast({
            variant: "destructive",
            title: "Accesso Fallito",
            description: "Impossibile completare l'accesso con questo provider. Riprova.",
        });
    } finally {
