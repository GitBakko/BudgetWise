...
const MetaIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg role="img" viewBox="0 0 90 90" {...props} xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="SVGID_1_SIGNUP" gradientUnits="userSpaceOnUse" x1="45" y1="77.3979" x2="45" y2="4.7082">
                <stop offset="0%" style={{stopColor: 'rgb(0,100,225)'}}/>
                <stop offset="100%" style={{stopColor: 'rgb(0,130,251)'}}/>
            </linearGradient>
        </defs>
        <path d="M 45 90 L 45 90 C 20.147 90 0 69.853 0 45 v 0 C 0 20.147 20.147 0 45 0 h 0 c 24.853 0 45 20.147 45 45 v 0 C 90 69.853 69.853 90 45 90 z" fill="url(#SVGID_1_SIGNUP)"/>
